...
// Method
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          labelText: 'ชื่อเจ้าหน้าที่ :',
          labelStyle: TextStyle(color: color),
          helperText: 'กรุณากรอกชื่อเจ้าหน้าที่',
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          labelText: 'User :',
          labelStyle: TextStyle(color: color),
          helperText: 'กรณากรอกชื่อ User',
          helperStyle: TextStyle(color: color),
          hintText: 'เฉพาะภาษาอังกฤษ',
        ),
      ),
    );
  }
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          labelText: 'Password :',
          labelStyle: TextStyle(color: color),
          helperText: 'กรณากรอกรหัส password',
          helperStyle: TextStyle(color: color),
          hintText: 'เฉพาะภาษาอังกฤษ',
        ),
      ),
  ...
  Future<void> uploadImageToServer() async {
    ...
    String url = 'http://infobizplus.com/DNA/saveFile.php';
  ...
  Future<void> uploadMySQL() async {
    ...
    String avatar = 'http://infobizplus.com/DNA/Member/$nameImage';

    String url = 'http://infobizplus.com/DNA/addUser.php?isAdd=true&Name=$name&User=$user&Password=$password&Avatar=$avatar';
